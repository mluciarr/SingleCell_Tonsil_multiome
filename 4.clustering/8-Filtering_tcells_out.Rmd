...
```{r}
# Paths
path_to_obj <- ("~/Documents/multiome_tonsil_Lucia/results/R_objects/12.tonsil_multiome_without_cluster7_doublets_normalized.rds")
...
tonsil_wnn_bcell$is_tcell <- 
  tonsil_wnn_bcell$wsnn_res.0.075 == "1" |
   tonsil_wnn_bcell$wsnn_res.0.075 == "4" |
   tonsil_wnn_bcell$wsnn_res.0.075 == "6" |
     tonsil_wnn_bcell$wsnn_res.0.075 == "7" 
...
tonsil_wnn_bcell <- FindClusters(tonsil_wnn_bcell, resolution = c(0.01,0.05,0.075,0.1),algorithm = 3, graph.name = "wsnn",verbose = FALSE)
...
write.csv(tonsil_markers_075,file=paste0("~/Documents/multiome_tonsil_Lucia/results/tables/", "tonsil_markers_bcell_075.csv"))
```
...
```{r}
tonsil_markers_075 %>% group_by(cluster) %>% top_n(n = 10, wt = avg_log2FC) %>% write.csv(.,file=paste0("~/Documents/multiome_tonsil_Lucia/results/tables/", "top10_tonsil_markers_bcell_075.csv"))

tonsil_markers_075 %>% group_by(cluster) %>% top_n(n = 5, wt = avg_log2FC) %>% write.csv(.,file=paste0("~/Documents/multiome_tonsil_Lucia/results/tables/", "top5_tonsil_markers_bcell_075.csv"))
